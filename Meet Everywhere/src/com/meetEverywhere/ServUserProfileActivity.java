...
public class ServUserProfileActivity extends Activity implements NotifiableLayoutElement {
    ...
    public void blockUser(View view) {
        ...
        refreshLayout();
        Toast.makeText(getApplicationContext(), "Użytkownik zablokowany",
    ...
    public void unlockUser(View view) {
        ...
        refreshLayout();
        Toast.makeText(getApplicationContext(), "Użytkownik odblokowany",
                Toast.LENGTH_SHORT).show();
    }
    ...
    public void deleteFriend(View view) {
        ...
        user.sendMessage(new FinishAcquiantanceMessage("", myself.getNickname(),
                myself.getUserID(), user.getUserID()), this);
    }

    public void sendInvite(View view) {
        User myself = Configuration.getInstance().getUser();
        user.sendMessage(new InvitationMessage(inviteMessage.getText().toString(),
                myself.getNickname(), myself.getUserID(), user.getUserID()), this);
    }
    ...
    public void acceptInvite(View view) {
        User myself = Configuration.getInstance().getUser();
        user.sendMessage(new InvitationAcceptedMessage("", myself.getNickname(), myself.getUserID(), user.getUserID()), this);
    }

    public void showMoreFromView(View view) {
        if (user.isInvited())
            Toast.makeText(getApplicationContext(),
                    "Zaproszenie zostało już wysłane", Toast.LENGTH_SHORT)
                    .show();
        else {
            if (visible) {
