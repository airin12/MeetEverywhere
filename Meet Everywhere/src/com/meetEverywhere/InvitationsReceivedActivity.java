...
/*		
		invites.add(new InvitationMessage("przyjmnij mnie do znajomych Panie", "Stañczyk", "asad112", "marek"));
		...
		invites.add(new InvitationMessage("Naród wspania³y, tylko ludzie kurwy.", "Marsza³ek Pi³sudski", "asad112", "marek"));
*/		
