...
public class User implements Comparable<User> {
    ...
    public static User deserializeObjectFromJSON(String jsonUser)
        ...
        // TODO: zmodyfikowaï¿½ przeysï¿½ane komunikaty ze wzglï¿½du na 4 flagi
        // "stanu znajomoï¿½ci" i flagï¿½ synchronizacji z serwerem
                ...
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        if (message instanceof TextMessage) {
                            ...
                            Log.i("Message sent", " WysÅ‚ano wiadomoÅ›Ä‡ o treÅ›ci: \"" + message.getText() +
                                    "\", do : " + message.getRecipient());
                        }

                        if (message instanceof InvitationMessage) {
                            setInvited(true);
                            Log.i("Message sent", " WysÅ‚ano zaproszenie do : " + message.getRecipient());
                        }
